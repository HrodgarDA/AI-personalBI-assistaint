...
from src.services.components.prompts import BATCH_CLASSIFICATION_PROMPT
...
class AIClassifier:
    ...
    async def classify_batch(
        ...
        try:
            ...
            return [
                TransactionClassification(
                    category="Uncategorized", merchant="Unknown", tipology="Outgoing",

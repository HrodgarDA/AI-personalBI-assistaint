...
BATCH_CLASSIFICATION_TEMPLATE = (
    ...
    "- Text: The raw transaction description.\n"
    "- Amount: The transaction value. Use this to help differentiate between categories (e.g. small vs large expenses).\n"
    "- Bank Suggestion: A category suggested by the bank. WARNING: This label is often too generic and MUST be verified against the official categories list and the merchant name.\n\n"
    "SYSTEM RULES:\n"
